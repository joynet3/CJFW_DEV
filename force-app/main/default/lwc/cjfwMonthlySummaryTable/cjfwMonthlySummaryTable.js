...
export default class CjfwMonthlySummaryTable extends LightningElement {
    customStyle = {
        id:'monthlySummary'
        ,style:`
        .monthlySummary.related-card .slds-card__header {
        ...
        .monthlySummary.related-card .slds-card__body {
            margin-top: 0;
            margin-bottom:0;
            border: 1px solid rgb(201,201,201);
            border-top: 0;
