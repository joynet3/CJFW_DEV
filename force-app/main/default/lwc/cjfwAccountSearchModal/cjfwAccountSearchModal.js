/**
cJFW_AccountSearchModal.cmp 에서 호출되는 js
*@group  
...
import getAccInfo from '@salesforce/apex/AccountGetInfoController.getAccInfo';

export default class cjfwAccountSearchModal extends LightningModal {
...
/*     columns = [
    ...
    */
    connectedCallback() {
        console.log(' # cjfwAccountSearchModal # connected call back ')
        ...
        if (this.message === 'FilterToCmp' && this.accountType !== undefined) {
            this.handleSearch();
        }
    ...
    */
    handleSearch(){
        console.log(' # cjfwAccountSearchModal # handleSearch   ')
        console.log(' # 고객사 검색 searchKey -> ' , this.searchKey );
        console.log(' # 고객사 검색 accountType -> ' , this.accountType );
        console.log(' # 고객사 검색 message -> ' , this.message );
    //&& this.searchKey.trim() !== ""
    ...
    */
    onDataChange(event){
        console.log(' # cjfwAccountSearchModal # onDataChange   ')
        /* this.searchKey =''; */
